...
const DataTitleSeoServices = [
    {
        titlePart1: 'What the',
        titlePart2: 'Seo Optimization?',
        description: `It is a set of strategies and techniques implemented on a website to improve its visibility and 
