...
export default function Section1() {
  return (
    <section className='flex flex-wrap justify-center items-center p-5 dark:bg-black'>
        <div className='flex flex-col gap-5 w-[40%] min-w-70'>
            <div className='text-4xl w-[80%] dark:text-white  font-bold'>
                <h2>
                We create
            ...
            <div>
                <button className=' w-40 p-2 border-1 dark:border-black rounded-2xl bg-blue-500 shadow-2xl text-white cursor-pointer transition-all duration-200 hover:opacity-75'>Get a Service</button>
            </div>
        </div>
