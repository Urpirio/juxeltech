...
export default function SubBestServices() {
  ...
  const list = DataBestServices.map( props => {
    return(
      <article key={props.keyId} className='flex flex-col border-1 border-gray-200 dark:border-black dark:shadow-gray-900 dark:shadow-md shadow-xl rounded-2xl w-80'>
      ...
      <div className='p-5 pb-2'>
        <h2 className='font-bold text-xl dark:text-white'>{props.Service}</h2>
